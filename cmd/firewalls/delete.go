...
func NewDeleteCmd() *cobra.Command {
	op := DeleteFirewallOperation{}
	cmd := &cobra.Command{
		Long:    "Delete a firewall by its ID.\n",
		RunE:    op.run,
		Short:   "Delete a firewall",
		Example: `  lsh firewalls delete fw_xxxxxxxx`,
		Use:     "delete <id>",
...
func (o *DeleteFirewallOperation) run(cmd *cobra.Command, args []string) error {
	id := args[0]
	...
	resp, err := client.Firewalls.Delete(ctx, id, operations.WithRetries(lsh.RetryConfig()))
	if err != nil {
